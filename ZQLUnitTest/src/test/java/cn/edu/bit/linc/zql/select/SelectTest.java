...
public class SelectTest extends DBTestCase {
    ...
    public final static String ORIGINAL_DATA_FILE = "../test_data/subquery_1_db.xml";   // 测试用的数据库
    ...
    public SelectTest(String name) throws Exception {
        ...
        // 数据库连接信息
        System.setProperty(PropertiesBasedJdbcDatabaseTester.DBUNIT_DRIVER_CLASS, CONFIG.DBUNIT_CONNECTION_URL);
        System.setProperty(PropertiesBasedJdbcDatabaseTester.DBUNIT_CONNECTION_URL, CONFIG.DBUNIT_DRIVER_CLASS + DB_NAME);
